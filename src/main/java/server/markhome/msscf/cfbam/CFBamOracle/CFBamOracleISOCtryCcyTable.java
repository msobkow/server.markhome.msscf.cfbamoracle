...
/*
 *	CFBamOracleISOCtryCcyTable Oracle Jdbc DbIO implementation
 *	for ISOCtryCcy.
 */
public class CFBamOracleISOCtryCcyTable
	implements ICFBamISOCtryCcyTable
{
	...
	public CFBamOracleISOCtryCcyTable( CFBamOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryCcyBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOCcyId )
	{
		final String S_ProcName = "CFBamOracleISOCtryCcyTable.readDerivedByIdIdx() ";
		CFSecISOCtryCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
