// Description: Java 11 Oracle Jdbc DbIO implementation for SchemaDef.
...
/*
 *	CFBamOracleSchemaDefTable Oracle Jdbc DbIO implementation
 *	for SchemaDef.
 */
	...
	implements ICFBamSchemaDefTable
{
		...
		long MinorVersionId )
	{
		...
		ResultSet resultSet = null;
		Connection cnx = schema.getCnx();
		CallableStatement stmtReadBuffByMinorVersionIdx = null;
		List<CFBamSchemaDefBuff> buffList = new LinkedList<CFBamSchemaDefBuff>();
		try {
			stmtReadBuffByMinorVersionIdx = cnx.prepareCall( "begin " + schema.getLowerDbSchemaName() + ".rd_schemadefbyminorversionidx( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " ); end;" );
			int argIdx = 1;
			stmtReadBuffByMinorVersionIdx.registerOutParameter( argIdx++, OracleTypes.CURSOR );
			...
			stmtReadBuffByMinorVersionIdx.execute();
			resultSet = (ResultSet)stmtReadBuffByMinorVersionIdx.getObject( 1 );
			if( resultSet != null ) {
				try {
					while( resultSet.next() ) {
						CFBamSchemaDefBuff buff = unpackSchemaDefResultSetToBuff( resultSet );
		...
		String AuthorEMail )
	{
		...
		ResultSet resultSet = null;
		Connection cnx = schema.getCnx();
		CallableStatement stmtReadBuffByAuthEMailIdx = null;
		List<CFBamSchemaDefBuff> buffList = new LinkedList<CFBamSchemaDefBuff>();
		try {
			stmtReadBuffByAuthEMailIdx = cnx.prepareCall( "begin " + schema.getLowerDbSchemaName() + ".rd_schemadefbyauthemailidx( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " ); end;" );
			int argIdx = 1;
			stmtReadBuffByAuthEMailIdx.registerOutParameter( argIdx++, OracleTypes.CURSOR );
			...
			stmtReadBuffByAuthEMailIdx.execute();
			resultSet = (ResultSet)stmtReadBuffByAuthEMailIdx.getObject( 1 );
			if( resultSet != null ) {
				try {
					while( resultSet.next() ) {
						CFBamSchemaDefBuff buff = unpackSchemaDefResultSetToBuff( resultSet );
		...
		String ProjectURL )
	{
		...
		ResultSet resultSet = null;
		Connection cnx = schema.getCnx();
		CallableStatement stmtReadBuffByProjectURLIdx = null;
		List<CFBamSchemaDefBuff> buffList = new LinkedList<CFBamSchemaDefBuff>();
		try {
			stmtReadBuffByProjectURLIdx = cnx.prepareCall( "begin " + schema.getLowerDbSchemaName() + ".rd_schemadefbyprojecturlidx( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " ); end;" );
			int argIdx = 1;
			stmtReadBuffByProjectURLIdx.registerOutParameter( argIdx++, OracleTypes.CURSOR );
			...
			stmtReadBuffByProjectURLIdx.execute();
			resultSet = (ResultSet)stmtReadBuffByProjectURLIdx.getObject( 1 );
			if( resultSet != null ) {
				try {
					while( resultSet.next() ) {
						CFBamSchemaDefBuff buff = unpackSchemaDefResultSetToBuff( resultSet );
		...
		long argMinorVersionId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "begin call " + schema.getLowerDbSchemaName() + ".dl_schemadefbyminorversionidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " ); end";
				...
				int rowsUpdated = stmtDeleteByMinorVersionIdx.executeUpdate();
		}
		catch( SQLException e ) {
			throw new CFLibDbException( getClass(),
				S_ProcName,
		...
		String argAuthorEMail )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "begin call " + schema.getLowerDbSchemaName() + ".dl_schemadefbyauthemailidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " ); end";
				...
				int rowsUpdated = stmtDeleteByAuthEMailIdx.executeUpdate();
		}
		catch( SQLException e ) {
			throw new CFLibDbException( getClass(),
				S_ProcName,
		...
		String argProjectURL )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "begin call " + schema.getLowerDbSchemaName() + ".dl_schemadefbyprojecturlidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " ); end";
				...
				int rowsUpdated = stmtDeleteByProjectURLIdx.executeUpdate();
		}
		catch( SQLException e ) {
			throw new CFLibDbException( getClass(),
				S_ProcName,
