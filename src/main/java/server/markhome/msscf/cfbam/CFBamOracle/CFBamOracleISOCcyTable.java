...
/*
 *	CFBamOracleISOCcyTable Oracle Jdbc DbIO implementation
 *	for ISOCcy.
 */
public class CFBamOracleISOCcyTable
	implements ICFBamISOCcyTable
{
	...
	public CFBamOracleISOCcyTable( CFBamOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCcyBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		short ISOCcyId )
	{
		final String S_ProcName = "CFBamOracleISOCcyTable.readDerivedByIdIdx() ";
		CFSecISOCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCcyBuff readDerivedByCcyCdIdx( CFSecAuthorization Authorization,
		String ISOCode )
	{
		final String S_ProcName = "CFBamOracleISOCcyTable.readDerivedByCcyCdIdx() ";
		CFSecISOCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCcyBuff readDerivedByCcyNmIdx( CFSecAuthorization Authorization,
		String Name )
	{
		final String S_ProcName = "CFBamOracleISOCcyTable.readDerivedByCcyNmIdx() ";
		CFSecISOCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
