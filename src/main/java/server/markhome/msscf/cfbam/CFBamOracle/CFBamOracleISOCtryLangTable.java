...
/*
 *	CFBamOracleISOCtryLangTable Oracle Jdbc DbIO implementation
 *	for ISOCtryLang.
 */
public class CFBamOracleISOCtryLangTable
	implements ICFBamISOCtryLangTable
{
	...
	public CFBamOracleISOCtryLangTable( CFBamOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryLangBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOLangId )
	{
		final String S_ProcName = "CFBamOracleISOCtryLangTable.readDerivedByIdIdx() ";
		CFSecISOCtryLangBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
