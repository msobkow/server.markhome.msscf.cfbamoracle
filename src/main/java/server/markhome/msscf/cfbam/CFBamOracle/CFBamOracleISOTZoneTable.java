...
/*
 *	CFBamOracleISOTZoneTable Oracle Jdbc DbIO implementation
 *	for ISOTZone.
 */
public class CFBamOracleISOTZoneTable
	implements ICFBamISOTZoneTable
{
	...
	public CFBamOracleISOTZoneTable( CFBamOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOTZoneBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		short ISOTZoneId )
	{
		final String S_ProcName = "CFBamOracleISOTZoneTable.readDerivedByIdIdx() ";
		CFSecISOTZoneBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOTZoneBuff readDerivedByUTZNameIdx( CFSecAuthorization Authorization,
		String TZName )
	{
		final String S_ProcName = "CFBamOracleISOTZoneTable.readDerivedByUTZNameIdx() ";
		CFSecISOTZoneBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
