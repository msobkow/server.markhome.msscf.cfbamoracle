// Description: Java 11 Oracle Jdbc DbIO implementation for ServiceType.
...
/*
 *	CFBamOracleServiceTypeTable Oracle Jdbc DbIO implementation
 *	for ServiceType.
 */
	...
	public String getSqlSelectServiceTypeDistinctClassCode() {
		if( S_sqlSelectServiceTypeDistinctClassCode == null ) {
			S_sqlSelectServiceTypeDistinctClassCode =
				...
				+	"FROM " + schema.getLowerDbSchemaName() + ".SvcType a013 ";
		}
