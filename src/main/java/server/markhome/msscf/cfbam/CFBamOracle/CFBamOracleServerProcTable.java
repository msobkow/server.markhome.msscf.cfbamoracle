// Description: Java 11 Oracle Jdbc DbIO implementation for ServerProc.
...
/*
 *	CFBamOracleServerProcTable Oracle Jdbc DbIO implementation
 *	for ServerProc.
 */
	...
	implements ICFBamServerProcTable
{
		...
		long TableId )
	{
		...
		List<CFBamServerProcBuff> buffList = new LinkedList<CFBamServerProcBuff>();
		try {
			stmtReadBuffByMethTableIdx = cnx.prepareCall( "begin " + schema.getLowerDbSchemaName() + ".rd_srvprcbymethtableidx( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " ); end;" );
			int argIdx = 1;
		...
		long argTableId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "begin call " + schema.getLowerDbSchemaName() + ".dl_srvprcbymethtableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " ); end";
