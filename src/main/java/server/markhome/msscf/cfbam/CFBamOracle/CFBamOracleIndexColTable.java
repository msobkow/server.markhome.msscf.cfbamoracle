// Description: Java 11 Oracle Jdbc DbIO implementation for IndexCol.
...
/*
 *	CFBamOracleIndexColTable Oracle Jdbc DbIO implementation
 *	for IndexCol.
 */
	...
	public String getSqlSelectIndexColDistinctClassCode() {
		if( S_sqlSelectIndexColDistinctClassCode == null ) {
			S_sqlSelectIndexColDistinctClassCode =
				...
				+	"FROM " + schema.getLowerDbSchemaName() + ".idxcol a822 ";
		}
