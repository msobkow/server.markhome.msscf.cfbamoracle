// Description: Java 11 Oracle Jdbc DbIO implementation for TopDomain.
...
/*
 *	CFBamOracleTopDomainTable Oracle Jdbc DbIO implementation
 *	for TopDomain.
 */
	...
	public String getSqlSelectTopDomainDistinctClassCode() {
		if( S_sqlSelectTopDomainDistinctClassCode == null ) {
			S_sqlSelectTopDomainDistinctClassCode =
				...
				+	"FROM " + schema.getLowerDbSchemaName() + ".tdomdef a107 ";
		}
