// Description: Java 11 Oracle Jdbc DbIO implementation for ServerListFunc.
...
/*
 *	CFBamOracleServerListFuncTable Oracle Jdbc DbIO implementation
 *	for ServerListFunc.
 */
	...
	implements ICFBamServerListFuncTable
{
		...
		long TableId )
	{
		...
		List<CFBamServerListFuncBuff> buffList = new LinkedList<CFBamServerListFuncBuff>();
		try {
			stmtReadBuffByMethTableIdx = cnx.prepareCall( "begin " + schema.getLowerDbSchemaName() + ".rd_srvlfuncbymethtableidx( ?, ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " ); end;" );
			int argIdx = 1;
		...
		long argTableId )
	{
		...
		try {
				Connection cnx = schema.getCnx();
				String sql = "begin call " + schema.getLowerDbSchemaName() + ".dl_srvlfuncbymethtableidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " ); end";
